...
public class ForwardHelper {
	...
	public static void toWelcomeViewPager(Activity activity) {
		Intent in = new Intent(activity, com.echo.yanji.A0_welcome.class);
	...
	public static void toRegist(Activity activity){
		Intent intent = new Intent(activity,com.echo.yanji.A2_regist.class);
		activity.startActivity(intent);
		activity.overridePendingTransition(R.anim.activity_open_in_anim, 
				R.anim.activity_open_out_anim);
	...
	public static void toForgetPWD(Activity activity){
		Intent intent = new Intent(activity,com.echo.yanji.A3_forgetpwd.class);
		activity.startActivity(intent);
		activity.overridePendingTransition(R.anim.activity_open_in_anim, 
				R.anim.activity_open_out_anim);
	...
	public static void toConect(Activity activity){
		Intent intent = new Intent(activity,com.echo.yanji.A4_conect.class);
		activity.startActivity(intent);
		activity.overridePendingTransition(R.anim.activity_open_in_anim, 
				R.anim.activity_open_out_anim);
	...
	public static void toMyinfo(Activity activity){
		Intent intent = new Intent(activity,com.echo.yanji.A5_myinfo.class);
		activity.startActivity(intent);
		activity.overridePendingTransition(R.anim.activity_open_in_anim, 
				R.anim.activity_open_out_anim);
	}
	...
	public static void toTest(Activity activity){
		Intent intent = new Intent(activity,com.echo.yanji.A6_test.class);
	...
	public static void backToTest(Activity activity){
		Intent intent = new Intent(activity,com.echo.yanji.B0_table.class);
		activity.startActivity(intent);
	...
	public static void toYanzhiDetail(Activity activity){
		Intent intent = new Intent(activity,com.echo.yanji.A7_yanzhidetail.class);
		activity.startActivity(intent);
		activity.overridePendingTransition(R.anim.activity_open_in_anim,
				R.anim.activity_open_out_anim);
	}
	...
	public static void toAnalyse(Activity activity){
		Intent intent = new Intent(activity,com.echo.yanji.A8_analyse.class);
		activity.startActivity(intent);
		activity.overridePendingTransition(R.anim.activity_open_in_anim, 
				R.anim.activity_open_out_anim);
	}
