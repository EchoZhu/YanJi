...
import com.echo.view.CircleProgressBar;
...
public class A8_analyse extends BaseActivity {
	...
	private void initData() {
		...
		new Thread(){
			public void run() {
				circleProgressbar1.setProgressNotInUiThread(40);
				circleProgressbar2.setProgressNotInUiThread(70);
				circleProgressbar3.setProgressNotInUiThread(40);
				circleProgressbar4.setProgressNotInUiThread(70);
				circleProgressbar5.setProgressNotInUiThread(70);
			};
		}.start();
	}
