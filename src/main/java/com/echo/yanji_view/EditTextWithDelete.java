/**
 * @(#)EditTextWithDelete.java, 2015年4月11日. Copyright 2012 Yodao, Inc.
...
public class EditTextWithDelete extends EditText implements
	...
	private void init() {
		...
		this.setPadding(40, top, 20, bottom);
	}
	...
	/**
	 * event.getX() 获取相对应自身左上角的X坐标 072. event.getY() 获取相对应自身左上角的Y坐标 073.
